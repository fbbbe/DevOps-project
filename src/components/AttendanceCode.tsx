...
import { ArrowLeft, RefreshCw, Check, QrCode, Clock, Users, AlertCircle } from 'lucide-react';
                ...
                {todayAttendance.map((attendance) => (
                  <div key={attendance.id} className="flex items-center justify-between p-3 bg-muted/30 rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-medium">{attendance.nickname}</p>
                        <p className="text-sm text-muted-foreground">({attendance.gender})</p>
                      </div>
                    </div>
