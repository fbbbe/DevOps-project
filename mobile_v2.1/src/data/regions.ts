// 대한민국 모든 시·도와 시·군·구 목록 (2025년 기준)
// 필요한 경우 최신 행정구역 변경 시 업데이트하세요.
export const KOREA_REGIONS: Record<string, string[]> = {
  ...
  '세종특별자치시': [
    '세종시' // 행정동 단위가 세분되어 있으나, 단일 선택용으로 표기
  ],
  '경기도': [
    '가평군','고양시 덕양구','고양시 일산동구','고양시 일산서구','과천시','광명시','광주시',
    '구리시','군포시','김포시','남양주시','동두천시','부천시','성남시 분당구','성남시 수정구','성남시 중원구',
  ...
  '충청북도': [
    '괴산군','단양군','보은군','영동군','옥천군','음성군','제천시','진천군','청주시 상당구','청주시 서원구',
    '청주시 청원구','청주시 흥덕구','충주시'
  ],
  '충청남도': [
  ...
  '전라북특별자치도': [
    '군산시','김제시','남원시','무주군','부안군','순창군','완주군','익산시','임실군','장수군',
