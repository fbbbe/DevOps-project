...
import { ArrowLeft, MapPin, Users, Calendar, Clock, Tag, QrCode, BarChart3, UserCheck, UserX, AlertTriangle, Settings } from 'lucide-react';
...
interface StudyDetailProps {
  ...
  user: User;
  onBack: () => void;
  onViewChange: (view: 'attendance' | 'progress') => void;
}
